...
function App() {
  ...
  //     setPosts(response.data).then((error) => {
  //       setPosts(error.data);
  //     });
  //   });
    ...
    <Container>
      <div className="App">
        ...
        {/* <div className="grid grid-cols-2 justify-between items-center gap-10 mb-20">
          ...
          <div>
            <p className="text-left">
              ...
              nostrum? Eveniet laudantium dicta sed adipisci distinctio qui non
              quae? Debitis!
            </p>
            <h1 className="text-left mt-6 font-extrabold text-black">
        ...
        {posts.slice(0, 6).map((item) => (
          <Commnents name={item.name} email={item.email} body={item.body} />
        ))}
